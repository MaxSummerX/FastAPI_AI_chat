...
router_v3 = APIRouter(prefix="/conversations_v2", tags=["conversations_v2"])
...
@router_v3.get("/", response_model=list[ConversationSchemas], status_code=status.HTTP_200_OK)
...
@router_v3.post("/", response_model=ConversationSchemas, status_code=status.HTTP_201_CREATED)
...
@router_v3.get("/{conversation_id}/messages", response_model=list[MessageSchemas], status_code=status.HTTP_200_OK)
...
@router_v3.post("/{conversation_id}/message", response_model=MessageSchemas, status_code=status.HTTP_201_CREATED)
...
@router_v3.post("/{conversation_id}/message/stream", status_code=status.HTTP_200_OK)
async def add_message_stream(
    ...
    history = await get_conversation_history(db=db, conversation_id=conversation_id, limit=10)
...
@router_v3.delete("/{conversation_id}", status_code=status.HTTP_200_OK)
