...
class UserRegister(BaseUser):
    ...
    Если REQUIRE_INVITE=True в настройках, invite_code обязателен.
    """

    username: str = Field(..., min_length=3, max_length=50, description="Имя пользователя")
    email: EmailStr = Field(..., max_length=255, description="Email пользователя")
    invite_code: str | None = Field(None, max_length=32, description="Инвайт-код (обязателен если REQUIRE_INVITE=True)")
